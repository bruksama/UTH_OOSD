...
const MyGrades = () => {
    ...
    const enrolledCourseCodes = new Set(enrollments.map(e => e.courseCode));

    const modalDepartments = ['All', ...Array.from(new Set(availableOfferings.map(o => o.department || 'General')))];

    const validOfferings = filterAvailableOfferings(availableOfferings, enrolledCourseCodes, modalDeptFilter);
    const gradeHierarchyView = getGradeHierarchyView(loadingGrades, gradeHierarchy.length);
    ...
    const handleAddEntry = async () => {
        ...
        try {
            const weight = Number.parseFloat(newEntryWeight) / 100; // Convert 20 to 0.2
                ...
                >
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-4 sm:gap-8 w-full sm:w-auto border-t sm:border-t-0 border-slate-100 pt-3 sm:pt-0">
                                ...
                                <div className="flex items-center sm:block">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            placeholder="--"
                                            onBlur={(e) => {
                                                const val = parseBoundedNumber(e.target.value, 0, 10);
                                                if (val !== null) handleScoreUpdate(entry.id!, val);
                                            }}
                        ...
                        <div className="flex items-center gap-1 sm:gap-2">
                            <button
                                aria-label={`Add sub-component to ${entry.name}`}
    ...
    return (
        <div className="space-y-4 lg:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
                ...
                <button
                    type="button"
                    aria-label="Toggle cumulative grade scale"
                    onClick={() => setIsScale4Primary(!isScale4Primary)}
                    className="w-full text-left bg-white p-4 lg:p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4 relative overflow-hidden group cursor-pointer hover:shadow-md transition-all select-none"
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-3xl p-6 lg:p-8 w-full max-w-md shadow-2xl transform transition-all border border-white/20">
                        <div className="flex justify-between items-center mb-6 lg:mb-8">
                            ...
                            <button aria-label="Close enrollment dialog" onClick={() => setShowAddModal(false)} className="p-2 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-xl transition-all">
                        ...
                        <div className="space-y-5 lg:space-y-6">
                            <div className="space-y-2">
                                <label htmlFor="enrollment-department" className="text-[10px] lg:text-xs font-black uppercase tracking-widest text-slate-400 ml-1">Department</label>
                                <select
                                    id="enrollment-department"
                            ...
                            <div className="space-y-2">
                                <label htmlFor="enrollment-offering" className="text-[10px] lg:text-xs font-black uppercase tracking-widest text-slate-400 ml-1">Select Offering</label>
                                <select
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl flex flex-col max-h-[90vh]">
                        ...
                        <div className="flex justify-between items-center p-6 border-b border-slate-100">
                            ...
                            <button aria-label="Close grade calculator" onClick={() => setShowGradeModal(false)} className="text-slate-400 hover:text-slate-600">
                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="p-6 border-t border-slate-100 bg-slate-50/50 rounded-b-2xl space-y-5 backdrop-blur-sm">
                            ...
                            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                                ...
                                <div className="flex gap-2 sm:gap-3">
                                    <div className="relative flex-1 sm:w-32 group">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (parseBoundedNumber(val, 0, max + 0.1) === null) return;
                                    ...
                                    <button
                                        aria-label="Add grade component"
