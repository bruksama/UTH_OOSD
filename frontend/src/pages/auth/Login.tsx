...
function Login() {
  ...
  // Get the redirect destination from location state, or default to role-based dashboard
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100">
      ...
      >
        <h2 className="text-2xl font-bold text-center mb-6">SPTS Login</h2>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-3 bg-white border border-slate-300 text-slate-700 font-semibold rounded-lg hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
          >
